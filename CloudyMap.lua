...
if _G.StopCloudyMap then
    pcall(_G.StopCloudyMap)
end

_G.StopCloudyMap = function()
...
sky.SkyboxBk = "rbxassetid://15063412549"
sky.SkyboxDn = "rbxassetid://15063341496"
sky.SkyboxFt = "rbxassetid://15063442046"
sky.SkyboxLf = "rbxassetid://15063367382"
sky.SkyboxRt = "rbxassetid://15063435355"
sky.SkyboxUp = "rbxassetid://15063353447"
sky.CelestialBodiesShown = false
sky.Parent = Lighting

Lighting.Technology = Enum.Technology.Future
Lighting.Ambient = Color3.fromRGB(162, 167, 170)
Lighting.OutdoorAmbient = Color3.fromRGB(188, 192, 196)
Lighting.Brightness = 1.35
Lighting.ColorShift_Top = Color3.fromRGB(175, 176, 172)
Lighting.ColorShift_Bottom = Color3.fromRGB(118, 124, 130)
Lighting.EnvironmentDiffuseScale = 0.45
Lighting.EnvironmentSpecularScale = 0.12
Lighting.ShadowSoftness = 0.9
Lighting.ClockTime = 7.35
Lighting.ExposureCompensation = 0.08
Lighting.FogColor = Color3.fromRGB(185, 190, 194)
...
atmosphere.Color = Color3.fromRGB(198, 202, 206)
atmosphere.Decay = Color3.fromRGB(112, 118, 126)
...
colorCorrection.TintColor = Color3.fromRGB(245, 243, 236)
colorCorrection.Parent = Lighting

setOcean({
    Color = Color3.fromRGB(118, 126, 134),
    Transparency = 0,
})

createLoopedSound(audioFolder, "Ambience", 9112751072, 0.75, 3, 2000)
local music = createMusicSound(audioFolder, "Music", 99526958001614)
startRandomizedMusic(music, 0.45, 3)
