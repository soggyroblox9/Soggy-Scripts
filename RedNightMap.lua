...
if _G.StopRedNightMap then
    pcall(_G.StopRedNightMap)
end

_G.StopRedNightMap = function()
...
Lighting.Ambient = Color3.fromRGB(98, 20, 20)
Lighting.OutdoorAmbient = Color3.fromRGB(145, 38, 38)
Lighting.Brightness = 1.7
Lighting.ColorShift_Top = Color3.fromRGB(160, 50, 50)
Lighting.ColorShift_Bottom = Color3.fromRGB(48, 10, 10)
...
Lighting.FogColor = Color3.fromRGB(115, 28, 28)
...
atmosphere.Color = Color3.fromRGB(200, 70, 70)
atmosphere.Decay = Color3.fromRGB(55, 10, 10)
