...
for i, scriptInfo in ipairs(scripts) do
	...
	if scriptInfo.CanStop then
		...
		killButton.MouseEnter:Connect(function()
			local colors = getTheme()
			tween(killButton, {BackgroundColor3 = colors.hover})
		end)

		killButton.MouseLeave:Connect(function()
			local colors = getTheme()
			tween(killButton, {BackgroundColor3 = colors.button})
		end)
	...
	button.MouseButton1Down:Connect(function()
		local colors = getTheme()
		tween(button, {BackgroundColor3 = colors.pressed}, 0.06)
	end)

	button.MouseButton1Up:Connect(function()
		local colors = getTheme()
		if activeScripts[scriptInfo.Name] then
			tween(button, {BackgroundColor3 = colors.active}, 0.08)
		else
			tween(button, {BackgroundColor3 = colors.button}, 0.08)
		end
	end)
...
closeButton.MouseEnter:Connect(function()
	local colors = getTheme()
	tween(closeButton, {BackgroundColor3 = colors.hover})
end)

closeButton.MouseLeave:Connect(function()
	local colors = getTheme()
	tween(closeButton, {BackgroundColor3 = colors.button})
end)
